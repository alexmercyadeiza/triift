      ...
      <div className="grid gap-10 min-h-screen p-6 md:grid-cols-2 md:gap-20 md:p-20">
        ...
        <div className="space-y-8 pb-10 self-center md:text-lg font-light">
          ...
          <div>
            ...
            second, doing what they know best; making the best of what they have
            and going against the tide to succeed at any cost. They defy the
            odds to defend a dream, they&rsquo;ve got grit and guts,
          ...
          <div>
            We know these businesses, they are the wooden shed restaurants with
            finger licking local delicacies, they are the fashion designers
            going long hours to make sure sunday&rsquo;s best is truly the best,
            they are the delivery companies weaving through traffic to get you
            your orders, they are everywhere, and we see them. What do we know?
            Africa&rsquo;s Medium, and small businesses experience challenges
            that go beyond conventional business and financial structures. This
            is why we built Triift Africa; to unlock growth by addressing these
            pockets of challenges, and smoothening the path to success for MSMEs
            in Africa.
          </div>
          <div>
            To reach full potential, Africa&rsquo;s businesses need products and
            services that match their grit and determination, empower their
            unconventional style of thinking, and keep them moving in the
            direction of growth. So, we are building for every touch point
            they&rsquo;ll need along the way. While they build Africa&rsquo;s
            resilient economic future, we&rsquo;ll be building everything these
            businesses will need to launch confidently, grow effortlessly, and
            scale exponentially.
          </div>
