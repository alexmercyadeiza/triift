    ...
    <div>
      ...
      <div className="text-black">
        ...
        <div className="">
          <div className="grid gap-10 md:grid-cols-2">
            <div className="space-y-10 self-center p-6 md:p-0 md:px-20">
              ...
              Starting out or growing a business? With or without a smartphone? 
              Save, join our community, access funding or business support and 
              training you need to move forward faster.
              </div>

              <button
                      onClick={() =>
                        router.push(
                          "https://banking.triift.africa"
                        )
                      }
        ...
        <div className="md:px-20 p-6 md:mt-40 mt-6 space-y-8">
          ...
          <div className="md:w-1/2">
            We think of ourselves as long term growth partners for underserved businesses ,
            and we&rsquo;re proud to keep helping business owners stay focused on what matters 
          ...
          <div className="grid md:grid-cols-3 gap-16">
            ...
            <div className="space-y-6">
              ...
              <div>
                Put money aside however and whenever you like even without a smartphone or bank account.
                Made for micro and growing business owners looking for a community to save with.  
                Save from your bank or with our ussd code, airtime, web or mobile app or our agent network.
            ...
            <div className="space-y-6">
              ...
              <div>
                Need cash to stock up, finance an invoice, upgrade your equipment, 
                open a new store, hire more hands, or expand your business?  
                Get access to our grant partners or between 10,0000-1 million naira 
                from 5% interest with zero collateral for up to 6 months. 
                Focus on growing your business with capital that keeps you running smoothly.
              </div>

              <div
                onClick={() =>
                  router.push("https://banking.triift.africa")
                }
                className="text-purple-one hover:text-purple-two cursor-pointer flex items-center space-x-3"
              >
                <div className="capitalize">Apply for Capital</div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-xl font-semibold">Growth Advisory</div>
              <div>
                One size never fits all with unique businesses like yours. Connect with our experts and get tailored, 
                hands on advisory that guides you to start, get funding or address specific business concerns without the fluff.
              </div>

              <div
                onClick={() => router.push("https://paystack.com/pay/consulttriiftafrica")}
                className="text-purple-one hover:text-purple-two cursor-pointer flex items-center space-x-3"
              >
                <div className="capitalize">Schedule a session</div>
                <svg
            ...
            <div className="space-y-6">
              ...
              <div>
                Make it official with our seamless business registration 
                process that only takes a few days.
              </div>

              <div
                onClick={() => router.push("https://forms.gle/ZxdEJ7BYq7fxBB2y9")}
                className="text-purple-one hover:text-purple-two cursor-pointer flex items-center space-x-3"
              >
           ...
           {/*  <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                Grow together with a community of business owners designed to help you thrive. 
                Build rich relationships, learn from shared growth experiences, and grow your 
                business with expert tips from growing business owners like yourself.

              </div>

              <div
                onClick={() => router.push("https://chat.whatsapp.com/HuJPzJYooPa6vaXgDqHw19")}
                className="text-purple-one hover:text-purple-two cursor-pointer flex items-center space-x-3"
              >
                <div className="capitalize">Join the community</div>
                <svg
            ...
            <div className="space-y-6">
                ...
                <div>
                  All you need to begin, operate, and grow your business. From marketing to business finance, 
                  and more, Never be lost again with our collection of rich courses, resources and templates 
      ...
      <div className="md:px-20 px-6 pt-20 pb-20 md:pb-20 md:mt-20 mt-6 bg-[#e3dcfc]  space-y-8 grid place-items-center">
        ...
        >
          ...
          >
            ...
            <div
              className="h-60 w-60 rounded-full bg-center /* bg-cover */"
            >
              <a href="https://ibb.co/dghvR6z"><img src="https://i.ibb.co/9tM072C/triiif.jpg" alt="triiif" border="0" style={{ width: '180px', height: '180px',   borderRadius: '50%', }}/></a>
          ...
          >
              ...
              className="h-60 w-60 rounded-full bg-center /* bg-cover */"
            >
              <a href="https://ibb.co/wcRB9yd"><img src="https://i.ibb.co/Drtzx41/triff2.jpg" alt="triff2" border="0" style={{ width: '180px', height: '180px',   borderRadius: '50%', }} /></a>
            </div>
            <div className="text-center text-xl font-semibold">SABI</div>
            <p className="text-center">Informal and Unbanked micro <br/>business owners </p>
          </div>
          ...
          >
            ...
            >
              <a href="https://ibb.co/SnttdXL"><img src="https://i.ibb.co/Phcc9ZS/triiftt.jpg" alt="triiftt" border="0"  style={{ width: '180px', height: '180px',   borderRadius: '50%', }}  /></a>
            </div>

            <div className="text-xl font-semibold text-center">SAVVY</div>
            <p className="text-center">Business owners that are banked<br/> and have an online presence</p>
          </div>
      ...
      <div className="w-full max-w-4xl mx-auto my-10 py-10">
        ...
        <div className="mx-4">
          <table className="min-w-full border border-gray-300">
            <thead>
              <tr>
                <th className="py-6 border px-4 text-xl">Membership Benefits</th>
                <th className="py-6 border px-4  text-xl">Free</th>
                <th className="py-6 border px-4 text-xl">Paid (7500 per year)</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="py-4 border px-4 text-center font-bold">Contribution platform</td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">✓</p></td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">✓</p></td>
              </tr>
              <tr>
                <td className="py-4 border px-4 text-center font-bold">Free Loan Processing</td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">x</p></td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">✓</p></td>
              </tr>
              <tr>
                <td className="py-4 border px-4 text-center font-bold">Discount on resources</td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">x</p></td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">✓</p></td>
              </tr>
              <tr>
                <td className="py-4 border px-4 text-center font-bold">Exclusive event with founders<br/> and top business experts</td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">x</p></td>
                <td className="py-4 border px-4 text-center"><p className="text-3xl">✓</p></td>
              </tr>
              <tr>
                <td className="py-4 border px-4 text-center font-bold">Perks and discount from <br/>Partners</td>
                <td className="py-4 border px-4 text-center font-bold">Some</td>
                <td className="py-4 border px-4 text-center font-bold">All</td>
              </tr>
              <tr>
                <td className="py-4 border px-4 text-center font-bold">Community</td>
                <td className="py-4 border px-4 text-center font-bold">Free Community</td>
                <td className="py-4 border px-4 text-center font-bold">Exclusive community</td>
              </tr>
              <tr>
                <td className="py-4 border px-4 text-center font-bold ">Join</td>
                ...
                <td className="py-4 border px-4 text-center ">
                  ...
                  <button
                      onClick={() =>
                        router.push(
                          "https://paystack.com/pay/savvytriift"
                        )
                      }
                      className="cursor-pointer border-none bg-purple-one hover:bg-purple-two text-white btn px-6 capitalize"
                    >
      ...
      <section className="md:px-20 px-6  pt-10 pb-20 md:pb-36 md:mt-20 mt-6 space-y-8 grid place-items-center bg-[#e3dcfc]">
        ...
        <div className="p-6 border border-gray-300 rounded-lg shadow-lg mx-8">
          <div className="relative">
            <img className="w-full h-auto rounded-lg" src="https://i.ibb.co/CwJXm81/Image2.jpg" alt="Image1" style={{ height: 300, width: 400 }} />
        ...
        <div className="p-6 border border-gray-300 rounded-lg shadow-lg mx-8">
       <div className="relative">
          <img className="w-full h-auto rounded-lg" src="https://i.ibb.co/vhjjDcb/Image-222.jpg" alt="Image1" style={{ height: 300, width: 400 }} />
        ...
        <p className="text-purple-one font-bold text-center pb-4">
         ...
         <div className="p-6 border border-gray-300 rounded-lg shadow-lg mx-8">
          <div className="relative">
            <img className="w-full h-auto rounded-lg" src="https://i.ibb.co/WD4BtcF/Image1.jpg" alt="Image1" style={{ height: 300, width: 400 }} />
            <div className="absolute inset-0 bg-black opacity-0 hover:opacity-70 transition-opacity duration-300 rounded-t-lg">
              <p className="text-white text-center py-40 text-2xl ">
                Elight Pictures
              </p>
      ...
      {/*   <div className="my-4 md:text-3xl text-2xl text-center font-semibold text-black mt-14 pt-14">
        ...
        <div className="md:px-20 px-6  pt-36 pb-20 md:pb-36 md:mt-20 mt-6 space-y-8 grid place-items-center">
          ...
          L.FC Product Updates, and Case Studies delivered freshly to your inbox!
