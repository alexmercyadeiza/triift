...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy &mdash; Triift Africa.</title>
      ...
      <div className="md:px-20 p-6 mt-6">
        ...
        <div className="space-y-8 mt-20">
          <div className="text-sm">
            Triift Africa (the “Company”) is committed to maintaining robust
          ...
          <div className="text-sm">
            For purposes of this Agreement, “Site” refers to the Company&rsquo;s
            website, which can be accessed at www.triift.africa. “Service”
            refers to the Company&rsquo;s services accessed via the Site, in
            which users can access business capital, growth advisory, business
            resources and templates, founder communities, and other business
            growth services. The terms “we,” “us,” and “our” refer to the
            ...
            and Terms of Use (found here: www.triift.africa/terms-of-use, and
            you consent to our collection, storage, use and disclosure of your
            Personal Information as described in this Privacy Policy.
          </div>

          <div className="text-sm space-y-2">
            <div className="font-bold">I. INFORMATION WE COLLECT</div>
            <div>
              ...
              Personal Information includes your email address, phone number,
              first names, date of birth, contact information, and other
              identification information, which you submit to us through the
            ...
            <div className="pl-14 space-y-4">
              <div className="space-y-2">
                ...
                <div>
                  ...
                  Information. However, in an effort to improve the quality of
                  the Service, we track information provided to us by your
                  browser or by our software application when you view or use
                  ...
                  identify you. We track this information using cookies, or
                  small text files which include an anonymous unique identifier.
                  Cookies are sent to a user&rsquo;s browser from our servers
                  and are stored on the user&rsquo;s computer hard drive.
                  Sending a cookie to a user&rsquo;s browser enables us to
                  collect Non-Personal information about that user and keep a
                  record of the user&rsquo;s preferences when utilizing our
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  your email address, and creating a user name and a password.
                  By registering, you are authorizing us to collect, store and
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  contact us at hello@triift.africa
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="pl-14 space-y-4">
              <div className="space-y-2">
                ...
                <div>
                  ...
                  our email communications who are provided access to
                  user&rsquo;s email address for purposes of sending emails from
                  us. Those vendors use your Personal Information only at our
          ...
          <div className="text-sm space-y-2">
            <div className="font-bold">III. HOW WE PROTECT INFORMATION</div>
            <div>
          ...
          <div className="text-sm space-y-2">
            ...
            <div>
              ...
              unsubscribe section of the newsletter, we will always provide a
              link. Please note that notwithstanding the promotional preferences
              you indicate by either unsubscribing or opting out in the
              unsubscribe section of the newsletter, we may continue to send you
          ...
          <div className="text-sm space-y-2">
            <div className="font-bold">V. LINKS TO OTHER WEBSITES</div>
            <div>
          ...
          <div className="text-sm space-y-2">
            <div className="font-bold">VI. CHANGES TO OUR PRIVACY POLICY</div>
            <div>
          ...
          <div className="text-sm space-y-2">
            <div className="font-bold">VII. CONTACT US</div>
            <div>
            ...
            <div>
              Last Updated: This Privacy Policy was last updated on the 3rd of
              September, 2022.
            </div>
          </div>
        </div>
